...
### Layout System
- `_layouts/` - Jekyll layout templates (default.html, post.html, opinion.html, page.html, post-wide.html, about.html, compress.html, default_design.html)
- `_includes/` - Reusable template components (navigation.html, footer.html, head.html, header.html, share_buttons.html, subscribe.html, pagination.html, post_footer.html, social_links.html)
- `_sass/` - Sass stylesheets for styling (31 SCSS partials: 20 root-level + 11 in basscss/ subdirectory)
...
- `feed.xml` - RSS feed (generated by jekyll-feed plugin)
...
- Note: `_config.yml` contains a legacy `formspree_id` key (unused); the active backend is Google Apps Script
