...
Picture a room whose door lock is wired to the light switch. The first person entering flips the light on, which locks the door against the janitor (writer). People stream in and out freely while the light is on. The last one out flips the light off. Now the janitor may enter. Nobody "owns" the light for the whole duration; ownership is an emergent property of the count.
