...
### Version 3: two semaphores (the Little Book of Semaphores lens)
...
4. Semaphore version: taking the mutex BEFORE `empty.acquire` is a deadlock (holding the mutex while blocking on the semaphore; consumers need the mutex to release you).
