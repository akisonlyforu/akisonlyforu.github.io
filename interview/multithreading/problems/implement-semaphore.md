...
- No busy-waiting.
- `release()` may be called by a thread that never acquired (semaphores have no ownership, that's a feature, and a conceptual question: bank #22).
