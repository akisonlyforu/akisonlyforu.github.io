...
3. Generalize to N threads round-robin (thread i prints i, i+N, 2i+N...): what changes? (Answer shape: condition becomes `current % T == myId`; everything else identical, solved for free.)
