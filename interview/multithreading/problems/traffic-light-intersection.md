...
**Source:** [LeetCode 1279](https://leetcode.com/problems/traffic-light-controlled-intersection/) (premium). Lower frequency: do once for completeness.
...
- Is fairness required (can road A hog the light)? (Not required by the problem, but say you noticed.)
